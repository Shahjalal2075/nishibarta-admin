        ...
        Swal.fire({
            ...
            if (selected) {
                ...
                if (confirm.isConfirmed) {
                    try {
                        await axios.patch(`https://nishibarta-server.vercel.app/delete-news/${id}`, { deleteStatus: selected, deletedBy: userDetails.username, deletedTime: new Date().toISOString() });
