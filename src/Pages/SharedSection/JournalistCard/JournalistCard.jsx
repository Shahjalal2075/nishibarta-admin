...
const JournalistCard = ({j}) => {
    return (
        <div
            className="relative bg-gradient-to-br from-white via-blue-50 to-white border border-blue-100 rounded-2xl shadow-md p-5 flex justify-between items-center hover:shadow-xl transition"
        >
